...
import EquipmentManagement from './components/equipment/Equipment';
      ...
      <div className="App">
        ...
        <div className="content">
          <Routes>
            ...
            <Route
              path="/operational_management"
              element={<Operational_management />}
            />
            ...
            <Route
              path="/communication"
              element={<CommunicationsAndNetworking />}
            />
