  ...
  return (
    <>
      ...
      <div className="om-content-container">
        <SmoothCurveChart/>
        <Common_block title="Генерація звітів" icon={LightBlueReportGeneration} />
        <Common_block title="Статистичний аналіз" icon={LightBlueStatisticalAnalysis} />
        <Common_block title="Прогнозування" icon={LightBlueForecasting} />
        <Common_block title="Візуалізація даних" icon={LightBlueDataVisualization} />
        <Common_block title="Оцінка ефективності" icon={LightBluePerformanceEvaluation} />
      </div>
    </>
  );
};
