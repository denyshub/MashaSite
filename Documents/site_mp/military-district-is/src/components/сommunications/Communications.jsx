  ...
  return (
    <>
      ...
      <div className="om-content-container">
        <Common_block
          title="Управління мережами зв'язку"
          icon={YellowNetworkManagement}
        />
        <Common_block
          title="Криптографічний захист"
          icon={YellowCryptography}
        />
        <Common_block
          title="Радіоелектронна боротьба"
          icon={YellowElectronicWarfare}
        />
        <Common_block
          title="Супутниковий зв'язок"
          icon={YellowSatelliteCommunication}
        />
