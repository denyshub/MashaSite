      ...
      items: [
        {
          ...
          answer:
            'Для входу в систему, введіть ваш логін та пароль на сторінці входу. Якщо у вас немає облікового запису, зверніться до адміністратора.',
        },
        {
          question: 'Як змінити пароль?',
          answer:
            'Перейдіть до розділу "Налаштування" і оберіть "Зміна паролю". Введіть старий пароль, новий пароль та підтвердження.',
        },
      ],
    },
    {
      ...
      items: [
        {
          ...
          answer:
            'У розділі "Налаштування" знайдіть пункт "Мова інтерфейсу" та виберіть бажану мову зі списку.',
        },
        {
          question: 'Як встановити часовий пояс?',
          answer:
            'Перейдіть до "Системні налаштування" та оберіть "Часовий пояс". Виберіть ваш часовий пояс із випадаючого списку.',
        },
      ],
    },
    {
      ...
      items: [
        {
          ...
          answer:
            'Двофакторна аутентифікація (2FA) забезпечує додатковий рівень безпеки, вимагаючи підтвердження особи за допомогою другого фактора, наприклад, коду з мобільного додатку.',
        },
        {
          question: 'Як активувати 2FA?',
          answer:
            'Перейдіть до розділу "Безпека та автентифікація" у налаштуваннях і оберіть "Двофакторна аутентифікація". Слідуйте інструкціям для налаштування.',
        },
      ],
    },
  ];
